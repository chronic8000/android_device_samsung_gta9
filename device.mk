...
# Audio: Update HAL versions from 7.0 to 8.0
PRODUCT_PACKAGES += \
    android.hardware.audio@8.0-impl:32 \
    android.hardware.audio.effect@8.0-impl:32 \
...
# Shipping API level (Required for Android 16 - API 35)
